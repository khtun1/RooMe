  ...
  if (results) {
    ...
    let locationCordinatesRes = await axios.get(
      "https://maps.googleapis.com/maps/api/geocode/json?address=" +
        result.address +
        "&key=AIzaSyBneqGWx7jvluwuqQ_BxRWN21YBs_iiaxw"
    );
    if (locationCordinatesRes.data.status === "OK") {
      result.mapLink =
        "https://www.google.com/maps/embed/v1/view?key=AIzaSyBneqGWx7jvluwuqQ_BxRWN21YBs_iiaxw&center=" +
    ...
    //console.log(locationCordinatesRes.data.results[0].geometry.location);
    //console.log(result);
